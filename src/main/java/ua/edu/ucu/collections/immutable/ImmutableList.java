...
public interface ImmutableList {
    ...
    ImmutableList add(int index, Object e); //додає елемент до
    // колекції за індексом, та кидає виключну ситуацію,
    ...
    ImmutableList set(int index, Object e); //змінює значення елементу
    // за індексом, та кидає виключну ситуацію,
    // якщо індекс виходить за межі колекції

    int indexOf(Object e); //шукає індекс елемента (повертає індекс
